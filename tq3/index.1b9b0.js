System.register(["./application.1f27f.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_application1f27fJs) {
      createApplication = _application1f27fJs.createApplication;
    }],
    execute: function () {
      createApplication({
