System.register(["./application.1af0f.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_application1af0fJs) {
      createApplication = _application1af0fJs.createApplication;
    }],
    execute: function () {
      createApplication({
